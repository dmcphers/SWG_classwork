...
--------------------
SELECT *
FROM Client where City = 'Metairie';

-- Is there a Client with the ClientId '818a7faf-7b4b-48a2-bf12-7a26c92de20c'?
-- nope
--------------------
SELECT *
FROM Client where ClientId = '818a7faf-7b4b-48a2-bf12-7a26c92de20c';
...
--------------------
SELECT FirstName, LastName, BirthDate FROM Client
WHERE BirthDate BETWEEN '1979-12-31' and '1990-01-01';
...
WHERE Price * Quantity BETWEEN 15.00 AND 25.00;
...
SELECT * FROM Goal WHERE GoalId = 3;

SELECT * FROM Goal WHERE GoalId = 8;

SELECT * FROM Goal WHERE GoalId = 15;
