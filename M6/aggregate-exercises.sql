...
--463 because some birthdays are null
...
SELECT 
	Description,
	AVG(Price * Quantity) InvoiceTotal
FROM InvoiceLineItem
...
SELECT
	l.Name LevelName,
	MIN(DATEDIFF(YEAR, c.BirthDate, GETDATE())) MinAge,
    MAX(DATEDIFF(YEAR, c.BirthDate, GETDATE())) MaxAge
FROM Level l
